...
class TutorProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        iHome = findViewById(R.id.ivHomeSiswa)
        bChat = findViewById(R.id.btnPilihTutor)

        iHome.setOnClickListener{
            val goHome = Intent(this@TutorProfile, HomeActivity::class.java)
            startActivity(goHome)
        }

        bChat.setOnClickListener{
            val goChat = Intent(this@TutorProfile, ChatTutorActivity::class.java)
